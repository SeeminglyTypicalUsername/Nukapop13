...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	RADIO_KEY_PITRATS = RADIO_CHANNEL_PITRATS,
	RADIO_KEY_DESERTRANGERS = RADIO_CHANNEL_DESERTRANGERS,
	RADIO_KEY_FOLLOWERS = RADIO_CHANNEL_FOLLOWERS,
	RADIO_KEY_MERCHANT = RADIO_CHANNEL_MERCHANT,
	RADIO_KEY_CHURCH = RADIO_CHANNEL_CHURCH,
