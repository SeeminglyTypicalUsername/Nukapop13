...
/obj/effect/mob_spawn/human/corpse/chineseremnant/assault
	...
	head = /obj/item/clothing/head/f13/chinese/helmet
	belt = /obj/item/storage/belt/military/alt

/obj/effect/mob_spawn/human/corpse/chineseremnant/officer
	name = "Chinese Remnant Pistoleer Corpse"
	uniform = /obj/item/clothing/under/f13/chinese/officer
	head = /obj/item/clothing/head/f13/chinese/officer
	neck = /obj/item/storage/belt/holster/legholster