...
/obj/item/clothing/suit/armor/f13/kit
	...
	icon_state = "armorkit"
	item_state = "armorkit"
	armor = list("melee" = 10, "bullet" = 15, "laser" = 5, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	strip_delay = 30
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/f13/punk
	...
	armor = list("melee" = 10, "bullet" = 15, "laser" = 6, "energy" = 6, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/f13/leatherarmor
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 10, "energy" = 25, "bomb" = 32, "bio" = 0, "rad" = 10, "fire" = 30, "acid" = 35, "wound" = 30)
	strip_delay = 40
	slowdown = 0.06
...
/obj/item/clothing/suit/armor/f13/metalarmor
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 25, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 45)
	slowdown = 0.22
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/metalarmor/reinforced
	...
	armor = list("melee" = 28, "bullet" = 25, "laser" = 20, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 50)
	slowdown = 0.3
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/combat/riotpolice
	...
	armor = list("melee" = 30, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 35, "wound" = 45)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/f13/combat/mk2
	...
	armor = list("melee" = 45, "bullet" = 40, "laser" = 30, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 55)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/f13/combat/swat
	...
	icon_state = "armoralt"
	item_state = "armoralt"
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 55)
...
/obj/item/clothing/suit/armor/bulletproof
	...
	item_state = "armor"
	blood_overlay_type = "armor"
	armor = list("melee" = 15, "bullet" = 30, "laser" = 25, "energy" = 25, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 50)
	strip_delay = 70
