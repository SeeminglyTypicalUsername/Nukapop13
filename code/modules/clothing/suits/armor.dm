...
/obj/item/clothing/suit/armor/vest
	...
	mutantrace_variation = STYLE_DIGITIGRADE|STYLE_NO_ANTHRO_ICON
	armor = list("melee" = 10, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 30)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/vest/big
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 25, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 40)
	slowdown = 0.18
