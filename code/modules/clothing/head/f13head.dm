...
/obj/item/clothing/head/helmet/f13/combat/swat
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 25, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 55)
...
/obj/item/clothing/head/f13/bandit
	...
	item_state = "fedora"
	flags_inv = HIDEHAIR
	armor = list("melee" = 5, "bullet" = 0, "laser" = 5, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/f13/gambler
	...
	item_state = "dethat"
	flags_inv = HIDEHAIR
	armor = list("melee" = 6, "bullet" = 0, "laser" = 5, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/rustedcowboyhat
	...
	flags_inv = HIDEEARS|HIDEHAIR
	armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/f13/riderw
	...
	icon_state = "riderw"
	item_state = "riderw"
	armor = list("melee" = 30, "bullet" = 20, "laser" = 20, "energy" = 15, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/head/helmet/f13/combat/riottribal
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 45, "energy" = 30, "bomb" = 45, "bio" = 55, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
