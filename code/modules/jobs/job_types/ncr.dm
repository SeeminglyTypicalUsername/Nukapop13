...
/datum/outfit/job/ncr/f13colonel	// Dress Uniform, Desert Eagle
	...
	head = /obj/item/clothing/head/f13/ncr/ncr_dresscap_senior
	neck = /obj/item/storage/belt/holster
	glasses = /obj/item/clothing/glasses/sunglasses/big
	gloves = /obj/item/clothing/gloves/f13/leather
	suit = /obj/item/clothing/suit/armor/f13/ncrarmor/ncr_dressjack_officer
...
/datum/job/ncr/f13lieutenant
	...
	loadout_options = list(
		/datum/outfit/loadout/mealtwo, //deagle
		/datum/outfit/loadout/mealeight, //deagle
		)
...
/datum/outfit/loadout/mealeight
	name = "Meal Eight"
	suit_store = null
	backpack_contents = list(
		/obj/item/storage/box/ration/menu_eight = 1
...
/datum/outfit/job/ncr/f13corporal/pre_equip(mob/living/carbon/human/H)
	. = ..()
	r_hand = pick(
		/obj/item/storage/box/gunbox/ncr/corporal/set1, //hunting rifle, scope
...
/datum/outfit/job/ncr/f13trooper/pre_equip(mob/living/carbon/human/H)
	...
	r_hand = pick(
		...
		/obj/item/storage/box/gunbox/ncr/trooper/set2) //service rifle
