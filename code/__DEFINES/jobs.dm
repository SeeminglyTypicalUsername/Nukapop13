...
#define F13POLICECHIEF	(1<<8)
#define F13FAITHFUL		(1<<9) // WHAT IS BITFLAG. WHAT DOES IT DO. WHERE IS THIS INFO USED.
#define F13TOWNDOCTOR	(1<<10)	// IDK MAN BUT IT SEEMS IMPORTANT
...
#define UNDERTOWN		(1<<17)

#define F13MERCHANT				(1<<0)
#define F13INSPECTOR			(1<<1)
#define F13UNDERTOWNCAPTAIN		(1<<2)
#define F13WATCHMAN				(1<<3)
#define F13ENFORCER				(1<<4)
#define F13FOREMAN				(1<<5)
#define F13WORKER    			(1<<6)
#define F13BARKEEP				(1<<7)
#define F13HIGHPRIEST			(1<<8)
#define F13SERVITORMEDICI		(1<<9)
#define F13SERVITORMILITANT		(1<<10)
#define F13PROSELYTIZER			(1<<11)
#define F13ACOLYTE				(1<<12)
#define F13NEOPHYTE				(1<<13)
#define F13UNDERTOWNRAIDER		(1<<14)
#define F13WASTER				(1<<15)
#define F13UNDERTOWNTRIBAL		(1<<16)

#define UNCR				(1<<18)

#define F13UCOLONEL		 (1<<0)
#define F13UCAPTAIN		 (1<<1)
#define F13ULIEUTENANT    (1<<2)
#define F13ULOGISTICSOFFICER (1<<3)
#define F13UMEDICALOFFICER (1<<4)
#define F13UDRILLSERGEANT (1<<7)
#define F13USERGEANT		 (1<<8)
#define F13UCORPORAL		 (1<<9)
#define F13UCOMBATENGINEER (1<<11)
#define F13UTROOPER		 (1<<12)
#define F13UREARECHELON	 (1<<14)
#define F13UMP            (1<<18)
#define F13UREP           (1<<19)

#define ULEGION			(1<<19)

#define F13ULEGATE		(1<<0)
#define F13UCENTURION	(1<<1)
#define F13UFRUMENTARIUS	(1<<2)
#define F13UDECANREC		(1<<4)
#define F13UDECAN		(1<<5)
#define F13UDECANVET		(1<<6)
#define F13UVEXILLARIUS	(1<<7)
#define F13UEXPLORER		(1<<8)
#define F13UVETLEGIONARY	(1<<10)
#define F13ULEGIONARY	(1<<11)
#define F13URECRUITLEG	(1<<12)
#define F13UAUXILIA		(1<<13)
#define F13ULEGIONSLAVE	(1<<14)
#define F13UCAMPFOLLOWER (1<<16)
...
#define JOB_DISPLAY_ORDER_SHERIFF 86
...
#define JOB_DISPLAY_ORDER_F13MERCHANT 175
#define JOB_DISPLAY_ORDER_F13INSPECTOR 176
#define JOB_DISPLAY_ORDER_F13UNDERTOWNCAPTAIN 177
#define JOB_DISPLAY_ORDER_F13WATCHMAN 178
#define JOB_DISPLAY_ORDER_F13ENFORCER 179
#define JOB_DISPLAY_ORDER_F13FOREMAN 180
#define JOB_DISPLAY_ORDER_F13WORKER 181
#define JOB_DISPLAY_ORDER_F13BARKEEP 182
#define JOB_DISPLAY_ORDER_F13HIGHPRIEST 183
#define JOB_DISPLAY_ORDER_F13SERVITORMEDICI 184
#define JOB_DISPLAY_ORDER_F13SERVITORMILITANT 185
#define JOB_DISPLAY_ORDER_F13PROSELYTIZER 186
#define JOB_DISPLAY_ORDER_F13ACOLYTE 187
#define JOB_DISPLAY_ORDER_F13NEOPHYTE 189
#define JOB_DISPLAY_ORDER_F13UNDERTOWNRAIDER 190
#define JOB_DISPLAY_ORDER_F13WASTER 191
#define JOB_DISPLAY_ORDER_F13UNDERTOWNTRIBAL 192

#define JOB_DISPLAY_ORDER_CAPTAIN_NCR 193
#define JOB_DISPLAY_ORDER_LIEUTENANT 194
#define JOB_DISPLAY_ORDER_LOGISTICSOFFICER 195
#define JOB_DISPLAY_ORDER_REPRESENTATIVE 196
#define JOB_DISPLAY_ORDER_MEDICALOFFICER 197
#define JOB_DISPLAY_ORDER_DRILLSERGEANT 198
#define JOB_DISPLAY_ORDER_SERGEANT 199
#define JOB_DISPLAY_ORDER_CORPORAL 200
#define JOB_DISPLAY_ORDER_COMBATENGINEER 201
#define JOB_DISPLAY_ORDER_TROOPER 202
#define JOB_DISPLAY_ORDER_REAR_ECHELON 203

#define JOB_DISPLAY_ORDER_CENTURION 204
#define JOB_DISPLAY_ORDER_FRUMENTARIUS 205
#define JOB_DISPLAY_ORDER_PRIESTESS 206
#define JOB_DISPLAY_ORDER_DECANREC 207
#define JOB_DISPLAY_ORDER_DECAN 208
#define JOB_DISPLAY_ORDER_DECANVET 209
#define JOB_DISPLAY_ORDER_VEXILLARIUS 210
#define JOB_DISPLAY_ORDER_EXPLORER 211
#define JOB_DISPLAY_ORDER_VENATOR 212
#define JOB_DISPLAY_ORDER_VETLEGIONARY 213
#define JOB_DISPLAY_ORDER_LEGIONARY 214
#define JOB_DISPLAY_ORDER_RECRUITLEG 215
#define JOB_DISPLAY_ORDER_CAMPFOLLOWER 216
#define JOB_DISPLAY_ORDER_IMMUNE 217
#define JOB_DISPLAY_ORDER_AUXILIA 218
#define JOB_DISPLAY_ORDER_LEGIONSLAVE 219