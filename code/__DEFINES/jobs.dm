...
GLOBAL_LIST_INIT(faction_list, list(FACTION_NCR, FACTION_LEGION, FACTION_KEBAB, FACTION_WASTELAND, FACTION_RAIDERS, FACTION_SALVATORES, FACTION_MORDINOS, FACTION_BISHOPS, FACTION_WRIGHTS, FACTION_PITRATS, FACTION_CHURCH, FACTION_MERCHANT))
