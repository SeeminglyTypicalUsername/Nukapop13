...
/datum/controller/subsystem/blackbox/proc/LogBroadcast(freq)
	...
	switch(freq)
		...
		if(FREQ_CHURCH)
			record_feedback("tally", "radio_usage", 1, "church")
		if(FREQ_ENGINEERING)
		...
		if(FREQ_MERCHANT)
			record_feedback("tally", "radio_usage", 1, "merchant")
		if(FREQ_CENTCOM)
		...
		if(FREQ_DESERTRANGERS)
			record_feedback("tally", "radio_usage", 1, "desertrangers")
		if(FREQ_SALVATORES)
			record_feedback("tally", "radio_usage", 1, "salvatores")
		if(FREQ_BISHOPS)
			record_feedback("tally", "radio_usage", 1, "bishops")
		if(FREQ_MORDINOS)
			record_feedback("tally", "radio_usage", 1, "mordinos")
		if(FREQ_WRIGHTS)
			record_feedback("tally", "radio_usage", 1, "wrights")
		if(FREQ_HOTEL)
			record_feedback("tally", "radio_usage", 1, "hotel")
		if(FREQ_FOLLOWERS)
			record_feedback("tally", "radio_usage", 1, "followers")
		if(FREQ_PITRATS)
			record_feedback("tally", "radio_usage", 1, "pitrats")
		else
