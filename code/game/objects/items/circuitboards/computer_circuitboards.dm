...
/obj/item/circuitboard/computer/enclave_mini_control
	name = "Enclave Mini Elevator Control (Computer board)"
	build_path = /obj/machinery/computer/shuttle/enclaveminielevator
