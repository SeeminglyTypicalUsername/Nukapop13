...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_PITRATS = FREQ_PITRATS,
	RADIO_CHANNEL_RANGER = FREQ_RANGER,
	RADIO_CHANNEL_DESERTRANGERS = FREQ_DESERTRANGERS,
	RADIO_CHANNEL_FOLLOWERS = FREQ_FOLLOWERS,
	RADIO_CHANNEL_MERCHANT = FREQ_MERCHANT,
	RADIO_CHANNEL_CHURCH = FREQ_CHURCH
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_PITRATS]" = RADIO_CHANNEL_PITRATS,
	"[FREQ_LEGION]" = RADIO_CHANNEL_LEGION,
	"[FREQ_RANGER]" = RADIO_CHANNEL_RANGER,
	"[FREQ_DESERTRANGERS]" = RADIO_CHANNEL_DESERTRANGERS,
	"[FREQ_FOLLOWERS]" = RADIO_CHANNEL_FOLLOWERS,
	"[FREQ_MERCHANT]" = RADIO_CHANNEL_MERCHANT,
	"[FREQ_CHURCH]" = RADIO_CHANNEL_CHURCH
))
